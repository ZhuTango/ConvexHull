...
public class MainActivity extends Activity {
	private Button creatDotsButton;// 产生点按钮
	private Button enumAllButton;// 枚举法按钮
	private Button grahamScanButton;// graham算法按钮
	private Button devidedButton;// 分治算法按钮
	...
	// float radius = 2;
	// canvas.drawCircle(radius, x, y, p);// 小圆
	// }
	// }
	//
	//
	...
	// .getX() + 20, listResult.get(i).getY() + 20, p);// 画线
	// }
	// }
	// }
	//
